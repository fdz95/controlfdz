...
<html>
	...
	<body class="hold-transition sidebar-mini layout-fixed">
									...
									<div class="card">
										<div class="card-header">
											<div class="input-group mb-3">
												<a href="#newGastoModal" class="btn btn-info" data-toggle="modal"><b>+</b> Nuevo gasto</a>
											</div>
										</div>
										<div class="card-body">
											<!-- Main content -->
											<div id="loader_gastos"></div>
											<div id="response_gastos"></div>
											<div class='outer_div_gastos'></div>
										</div>
									</div>
									<!-- /.card -->
								</div>
		...
		<?php include("html/modal_add_gasto.php");?>
		<!-- Edit Trabajo Modal HTML -->
		<?php include("html/modal_edit_gasto.php");?>
		<!-- Info Trabajo Modal HTML -->
		<?php include("html/modal_info_gasto.php");?>
		<!-- Delete Trabajo Modal HTML -->
		<?php include("html/modal_delete_gasto.php");?>
		<!-- Payment Trabajo Modal HTML -->
		<?php include("html/modal_add_payment_gasto.php");?>
		<!-- Change Estado Modal HTML -->
		<?php include("html/modal_change_estado_gasto.php");?>
		<!-- Logout Modal HTML -->
