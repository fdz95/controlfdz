<div id="cambiarEstadoTrabajoModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form name="cambiar_estado_trabajo_modal" id="cambiar_estado_trabajo_modal">
				<div class="modal-header">						
					<h4 class="modal-title">Cambiar estado</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				</div>
				<div class="modal-body">
					<input type="hidden" name="id_trabajo_estado" id="id_trabajo_estado">
					
					<div class="form-group">
						<input type="radio" id="estado_en_rep" name="cambiar_estado" value="EN_REP" checked>
						...
						<label for="estado_no_rep">Esperando pago</label>
					</div>
					<label id="response_cambiar_estado"></label>
				</div>
				<div class="modal-footer">
					<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">
					<input type="submit" id="button_change_estado" class="btn btn-info" value="Cambiar">
				</div>
			</form>
		</div>
	</div>
