<div id="newTrabajoModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form name="add_trabajo_modal" id="add_trabajo_modal">
				...
				<div class="modal-body">
					<div class="form-group">
						<label>Cliente</label><a href="#addClienteModal" data-toggle="modal"> Agregar</a></br>
					...
					<div class="form-group">
						<label>Trabajo</label><a href="#addTipoTrabajoModal" data-toggle="modal"> Agregar</a></br>
						<select id="add_trabajo_select" name="add_trabajo_select" style="width:100%;"></select>
					</div>
					
					<div class="form-group">
						<label>Equipo/Repuesto</label>
				...
				<div class="modal-footer justify-content-between">
					...
					<input type="submit" id="button_add_trabajo" class="btn btn-success" value="Agregar">
				</div>
			</form>
		</div>
	</div>
