<?php
	$newEstado = null;
	if (empty($_POST['id_gasto_estado'])){
		$errors[] = "ERROR id_gasto_estado";
	} else if (!empty($_POST['id_gasto_estado'])){
		require_once ("conexion.php");
		$id_gasto_estado = mysqli_real_escape_string($conexion,(strip_tags($_POST["id_gasto_estado"],ENT_QUOTES)));
		...
		if(empty($cambiar_estado)){
			...
			$query_update_estado = "UPDATE t_gastos SET estado = '$newEstado' WHERE Id = '$id_gasto_estado';";
